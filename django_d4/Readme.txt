...
---------------------------------------
Регистрация по emaill и паролю
!!!!!!!!!!!!!
...
https://django-allauth.readthedocs.io/en/latest/account/signals.html?highlight=allauth.account.signals.user_signed_up#signals
есть список таких сигналов. Из них мы можем выбрать тот, который овечает за регистрацию
пользователя, (allauth.account.signals.user_signed_up) и указать, что при его
...
модели.
Для наала посмотрим на несколько стандартных сигналов Django.
...
приложения simpleapp. В амом методе импортируем сигналы, таким образом
зарегистрировав их.
...
simpleapp/management/commands/runapscheduler.py у ас станет доступна команда
